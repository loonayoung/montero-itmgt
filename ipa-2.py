...
def shift_by_letter(letter, letter_shift):
    ...
    if letter != " ":
        if alphabet.index(letter)+alphabet.index(letter_shift)>25:
            letter_shifted= alphabet[alphabet.index(letter)+alphabet.index(letter_shift) - 26]
        else:
            letter_shifted= alphabet[alphabet.index(letter)+alphabet.index(letter_shift)]
    else:
        letter_shifted = " "
...
def vigenere_cipher(message, key):
    ...
    if len(message)>len(key):
        temp = key*((len(message)//len(key)) + (len(message)%len(key)>0))
        key = temp[:len(message)]
    for i in range(len(message)):
        if message[i] != " ":
            if alphabet.index(message[i])+alphabet.index(key[i])>25:
                mssg_key_shifted += alphabet[alphabet.index(message[i])+alphabet.index(key[i]) - 26]
            else:
                mssg_key_shifted += alphabet[alphabet.index(message[i])+alphabet.index(key[i])]
        else:
            mssg_key_shifted += " "
    return mssg_key_shifted
